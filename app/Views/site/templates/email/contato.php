<!doctype html>
    <html>
        ...
        <title>Contato | Amigo Não se Abandona</title>
        <style>
            /* -------------------------------------
                GLOBAL RESETS
            ------------------------------------- */
            ...
            .btn-primary table td:hover {
                background-color: #623e65 !important; 
            }
            .btn-primary a:hover {
                background-color: #623e65 !important;
                border-color: #623e65 !important; 
            } 
            }
        ...
        <body class=''>
        <span class='preheader'>Contato via Site</span>
            ...
            <td class='container'>
                ...
                <table role='presentation' class='main'>
                    ...
                    <td class='wrapper'>
                        ...
                        <tr>
                            <td>
                                <p>Contato de <span class='purple-span'><?=$mensagem['nome']?></span></p>
                                <p><span class="purple-span">E-mail:</span> <?=$mensagem['email']?></p>
                                <p><span class="purple-span">Telefone:</span> <?=$mensagem['telefone']?></p>
                                <p><span class="purple-span">Mensagem:</span> "<?=$mensagem['mensagem']?>"</p>

...
class Perfil extends Controller
{
    ...
    public function petsCadastrados()//Lista Informações de de pets cadastrados
	{
        helper('form');
        $data['title'] = 'Meus pets cadastrados';
        ...
        echo view('site/paginas/perfil_content/perfil_petsCadastrados', $data);
    }
